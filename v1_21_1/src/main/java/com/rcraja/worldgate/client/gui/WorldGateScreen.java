...
import net.client.client.gui.screen.ConfirmLinkScreen;
import net.client.client.gui.screen.ConnectScreen;
import net.client.client.gui.screen.Screen;
import net.client.client.network.ServerInfo;
import net.client.client.network.ServerAddress;
import net.client.server.integrated.IntegratedServer;
import net.client.text.Text;
import net.client.world.GameMode;
