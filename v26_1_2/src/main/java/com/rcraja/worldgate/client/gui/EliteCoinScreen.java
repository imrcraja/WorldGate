...
public final class EliteCoinScreen extends Screen {
    ...
    private void requestPackage(){String r=EliteCoinManager.requestPackage("starter");status=r==null?"Elite Coin packages are coming soon.":(r.contains("GATEWAY_REQUIRED")?"Elite Coin packages are coming soon.":"Purchase response received.");}
